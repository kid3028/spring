...
/**
 * 解析 {@link Configuration @Configuration} 的注解的BeanDefinition。
 * 由于导入其他ConfigurationClass的可能，一个Configuration class的处理可能影响一系列的ConfigurationClass
 *
...
class ConfigurationClassParser {
	...
	/**
	 * 对class的一个包装，使他们可以被同一地管理，不管class是否加载
